void plot(){
    ...
    // DrawingTools draw("/sps/t2k/quocviet/data/merge_file_accum_2_test.root");
    // DataSample mc("/sps/t2k/quocviet/data/merge_file_accum_2_test.root");
    // TCanvas *c1 = new TCanvas("c1","c1", 800,600);
    // draw.Draw(mc, "selmu_mom", 200, 0, 6000, "reaction", "accum_level[][0]>1");
    ...
    DrawingTools draw("/sps/t2k/quocviet/data/final_merge_dir/merge_accum_2.root");
    DataSample* mc = new DataSample("/sps/t2k/quocviet/data/final_merge_dir/merge_accum_2.root");
    ...
    // draw.Draw(exp, "selmu_mom", 200, 0, 6000, "reaction", "accum_level[][0]>3 ");
    // draw.Draw(exp, "selmu_mom", 200, 0, 6000, "reaction", "accum_level[][0]>3 && ((abs(selvtx_truepos[0])<874.51 && abs(selvtx_truepos[1]-55)<874.51 && selvtx_truepos[2]>136.875 && selvtx_truepos[2]<446.955) || (abs(selvtx_truepos[0])<860 && abs(selvtx_truepos[1]-55)<860 && selvtx_truepos[2]>1481.45 && selvtx_truepos[2]<1787.83))");
    // draw.Draw(exp, "selmu_mom", 200, 0, 6000, "reaction", "accum_level[][0]>5 && !"+FV_bothFGD);
    // draw.Draw(exp, "selmu_mom", 200, 0, 6000, "reaction", "accum_level[][0]>5 && "+sel_reco_FV_bothFGD);
    ...
    // draw.Draw(exp, "selmu_mom", 200, 0, 6000, "reaction", "accum_level[][0]>5 && "+sel_reco_FV_FGD2);
    ...
    // draw.Draw(exp, "selmu_mom", 200, 0, 6000, "fgd2reaction", "accum_level0][1][0]>5 && !"+sel_true_FV_FGD2);
    // draw.Draw(exp, "selmu_mom", 200, 0, 6000, "fgd2reaction", "accum_level0][1][0]>5 ");
