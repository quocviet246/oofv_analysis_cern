void plot_anu(){
    ...
    DrawingTools draw("/sps/t2k/quocviet/data/final_merge_dir/hl2_accum_cut_2_output_AntiNumuCCAnalysis.root");
    DataSample* mc = new DataSample("/sps/t2k/quocviet/data/final_merge_dir/hl2_accum_cut_2_output_AntiNumuCCAnalysis.root");
    ...
    // draw.Draw(exp, "selmu_mom", 200, 0, 6000, "reaction", "accum_level[][0]>6 && "+sel_reco_FV_FGD2);

    // draw.Draw(exp, "selmu_mom", 200, 0, 6000, "fgd2reaction", "accum_level[0][1][0]>6 && "+sel_reco_FV_FGD2);
